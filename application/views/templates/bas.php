...
<footer class="footer section">
    ...
    <!-- Main jQuery -->
    <script src="<?php echo base_url();?>style/plugins/jquery/jquery.js"></script>
    <script src="<?php echo base_url();?>style/js/contact.js"></script>
    <!-- Bootstrap 4.3.1 -->
    <script src="<?php echo base_url(); ?>style/plugins/bootstrap/js/popper.js"></script>
    <script src="<?php echo base_url(); ?>style/plugins/bootstrap/js/bootstrap.min.js"></script>
   <!--  Magnific Popup-->
    <script src="<?php echo base_url(); ?>style/plugins/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
    <!-- Slick Slider -->
    <script src="<?php echo base_url(); ?>style/plugins/slick-carousel/slick/slick.min.js"></script>
    <!-- Counterup -->
    <script src="<?php echo base_url(); ?>style/plugins/counterup/jquery.waypoints.min.js"></script>
    <script src="<?php echo base_url(); ?>style/plugins/counterup/jquery.counterup.min.js"></script>

    <!-- Google Map -->
    <script src="<?php echo base_url(); ?>style/plugins/google-map/map.js"></script>
