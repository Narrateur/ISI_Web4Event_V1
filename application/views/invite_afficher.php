    ...
    <div class='container'>
        ...
        <div class='row'>
			...
			<?php 
                ...
                // DEBUT AFFICHAGE
				if($invite != NULL) {
					foreach($invite as $invInfo){// POUR CHAQUE ELEMENTS RETOURNE PAR LA REQUETE
                        if (!isset($urlTraite[$invInfo["cpt_pseudo"]])){// SI ON LE L'A PAS DEJA AFFICHE
                            echo"<div class='col-lg-6 col-md-6 mb-5'>
                                    <div class='blog-item'>
                                        ...
                                        <div class='blog-item-content bg-white p-5'>
                                            ...
                                            <h3 class='mt-3 mb-3'><a href='#'>".$invInfo["inv_nom"]."</a></h3>
                                            ".$invInfo["inv_description"]."<br>
                                            </div> 
                            ...
                            if($post_added==0)echo"Pas de post pour cet invité !";
                            echo"</p>";
